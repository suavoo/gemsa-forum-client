...
import { isPasswordValid, PasswordTestResult } from "../../validators/PasswordValidator"
...
const Registration: FC<ModalProps> = ({ isOpen, onClickToggle }) => {
    ...
    const [
        { userName, password, email, passwordConfirm, resultMsg, isSubmitDisabled }, dispatch,
            ...
            <form>
                <div className="reg-inputs">
                    ...
                    <div>
                        ...
                        <input type="password" placeholder="Confirm Password" value={passwordConfirm} onChange={onChangePasswordConfirm} />
                    </div>
                </div>
